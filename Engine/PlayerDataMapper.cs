            ...
            try
            {
                ...
                using (SqlConnection connection = new SqlConnection(_connectionString))
                {
                    ...
                    using (SqlCommand savedGameCommand = connection.CreateCommand())
                    {
                        ...
                        //Use Execute Reader when you expect the query to return a row, or rows
                        ...
                        // Get the column vlaues for the row/Record
                    ...
                    //Read the rows/record from the Quest table, and add them to the player
                    ...
                    //Read the rows/records form the Inventory table, and add them to the player
                    ...
                    using (SqlCommand existingRowCountCommand = connection.CreateCommand())
                    {
                        ...
                        if(existingRowCount == 0)
                        {
                            ...
                            using (SqlCommand insertSavedGame = connection.CreateCommand())
                            {
                                ...
                                insertSavedGame.CommandText =
                                    "INSERT INTO SavedGame " + "(CurrentHitPoints, MaximumHitPoints, Gold, ExperiencePoints, CurrentLocationID) "
                        ...
                        else
                        {
                            ...
                            using (SqlCommand updateSavedGame = connection.CreateCommand())
                            {
                                ...
                                //Pass the values from the player object, to the SQL query, using parameters
                                //Using parameters helps make your program more secure. It will prevent SQL injection attacks.
