...
namespace Engine
{
    public static class World
    {
        ...
        private static void PopulateItems()
        {
            ...
            Items.Add(new Weapon(ITEM_ID_CLUB, "Club", "Clubs", 3, 1));
        ...
        private static void PopulateLocations()
        {
            ...
            Location townSquare = new Location(LOCATION_ID_HOME, "Town square", "You see a fountain.");
            ...
            Location bridge = new Location(LOCATION_ID_BRIDGE, "Bridge", "A stone bridge cvrosses a wide river.");
