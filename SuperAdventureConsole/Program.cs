        ...
        private static void ParseInput(string input)
        {
            ...
            else if (input.StartsWith("buy "))
            {
                ...
                else
                {
                    ...
                    {
                        //Get the InventoryIUtem from the trader's inventory
            ...
            else if(input.StartsWith("sell "))
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        InventoryItem itemToSell = _player.CurrentLocation.VendorWorkingHere.Inventory.SingleOrDefault(x => x.Details.Name.ToLower() == itemName);
                        ...
                        else
                        {
                                ...
                                Console.WriteLine("You receive {0} gold for your {1}", itemToSell.Details.Name, itemToSell.Price);
                        }
                    }
                }
            }
